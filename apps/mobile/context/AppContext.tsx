...
import { cancelAlarm, playLoopingAlarm, scheduleTaskAlarm, stopLoopingAlarm } from "@/utils/alarmService";
...
type AppContextType = {
  ...
  triggerTimerAlarm: () => void;
  dismissTimerAlarm: () => void;
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const triggerTimerAlarm = useCallback(() => {
    ...
    playLoopingAlarm(profileRef.current.alarmSound);
  }, []);
